...
#Datei mit B64-Verfahren in Text konvertieren, Prä- und Postfixe anhängen --> Text Stückweise in Liste (data_list) schreiben
data_list[0] = prefix
with open(inputfile_name, 'rb') as binary_file:
    binary_file_data = binary_file.read(1000)
    while binary_file_data:
        base64_encoded_data = base64.b64encode(binary_file_data)
        data_list.append(base64_encoded_data.decode('utf-8'))
        binary_file_data = binary_file.read(1000)
      

data_list.append(postfix_1+postfix_2)
